...
try:
    ...
    fig_2021income = px.bar(
        ...
        color_discrete_sequence=["#0b5f9f"] * len(income2021_slice),
    ...
    fig_2014income = px.bar(
        ...
        color_discrete_sequence=["#ffe599"] * len(income2021_slice),
        template="plotly_white"
    )
    ...
    fig_2021phd = px.bar(
        ...
        color_discrete_sequence=["#0b5f9f"] * len(phd2021_slice),
        template="plotly_white"
    )
    ...
    fig_2014phd = px.bar(
        ...
        color_discrete_sequence=["#ffe599"] * len(phd2014_slice),
        template="plotly_white"
    )
