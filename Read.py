...
st.markdown("##")
st.write("The dashboard allows exploration of all results and submissions data ('REF Overview data'), subject-specific comparisons ('UOA stats'), and shifts in funding outcomes ('Funding stats').")
st.markdown("##")
...
st.write("2021/22 UK HE funding data are [here](https://www.ukri.org/publications/funding-allocations-2021-to-2022-documents-for-providers/) for UOAs, [here](https://www.ukri.org/what-we-offer/what-we-have-funded/research-england/re-funding-allocations-from-2021-to-2022/) for HEIs, and [here](https://www.ukri.org/publications/quality-related-research-qr-funding-supporting-information-for-2021-to-2022/) by HEI by UOA.")
st.write("2022/23 UK HE funding data are [here](https://www.ukri.org/publications/grant-allocations-2022-to-2023-general-supporting-information/) for UOAs, [here](https://www.ukri.org/what-we-offer/what-we-have-funded/research-england/research-england-funding-allocations-from-2022-to-2023/) for HEIs, and [here](https://www.ukri.org/publications/qr-funding-supporting-information-for-2022-to-2023/) by HEI by UOA.")
st.markdown("##")
st.write("Tom Palmer")
st.write("2023")
